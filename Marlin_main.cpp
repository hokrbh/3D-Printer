...
void deploy_z_probe() {
  ...
  destination[Y_AXIS] = 0; // T3P3 Kossel Mini R2
  destination[Z_AXIS] = 30;
  prepare_move_raw();
  
  /*destination[X_AXIS] = 30; // T3P3 Kossel Mini R2
  destination[Y_AXIS] = 88; // T3P3 Kossel Mini R2
...
void retract_z_probe() {
  feedrate = homing_feedrate[X_AXIS];
  destination[Z_AXIS] = current_position[Z_AXIS] + 50; // T3P3 Kossel Mini R2
  prepare_move_raw();
