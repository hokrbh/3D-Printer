...
#define DELTA_SMOOTH_ROD_OFFSET 144.3 // mm  (T3P3, default 145) //145.1 = redkossel
...
#define MANUAL_Z_HOME_POS 223.2 // T3P3, with V6 and heated bed. With J-head and no heated bed start at 255
...
#define Z_PROBE_OFFSET {0.0, -14.0, -1.7, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe for T3P3 with V6

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 656} // T3P3 for 20T pulleys & RRP mini geared extruder
